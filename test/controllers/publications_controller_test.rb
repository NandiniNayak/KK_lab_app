...
class PublicationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publication" do
    assert_difference('Publication.count') do
      post publications_url, params: { publication: { title: @publication.title, year: @publication.year } }
    end
  ...
  test "should update publication" do
    patch publication_url(@publication), params: { publication: { title: @publication.title, year: @publication.year } }
